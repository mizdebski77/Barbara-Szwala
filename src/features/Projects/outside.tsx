...
import { Architecture } from "../../common/ProjectsBase/Outside/Projekt Domu/outsideArray";
        ...
        <section>
            ...
            <div className="min-h-screen  text-center md:p-24 p-6  relative">
                ...
                {Architecture.map((project) => (
                    <a href={`Architektura/${project.id}`} key={project.id} className="grid md:grid-cols-3 gap-8">
